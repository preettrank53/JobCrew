...
def render_header():
    ...
    st.markdown("<h4 style='text-align: center; color: gray;'>AI-powered job application assistant — Job Analysis, Resume, LinkedIn Outreach, and Interview Prep</h4>", unsafe_allow_html=True)
    st.divider()
